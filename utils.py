'''
    utils.py:读取config.ini配置文件，获取整个UWB设备的相关参数
'''
import os
import numpy as np
import configparser
...
'''
def CONFIG():
    global FPS,RANGE_END,RANGE_SATRT,RANGE_RESOLUTION,OFFSET,FRAMES,NFFT,MAX_BIN,STEP
'''
...
FPS = 60 if fps_value is None else fps_value
